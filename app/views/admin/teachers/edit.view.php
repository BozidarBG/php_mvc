...
<div class="col-md-12">
    ...
    <div class="card card-nav-tabs">
        ...
        <div class="card-body">
            ...
            ?>
            <form method="POST" action="/admin-update-teacher/<?= $teacher->id ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="about" rows="5"><?php echo $teacher->about ?></textarea>
                ...
                <div class="row ">
                    <div class="col-md-12">
                        <div class="">
                            ...
                            <img src="/files/images/<?= $teacher->photo ?>" width="300px">
